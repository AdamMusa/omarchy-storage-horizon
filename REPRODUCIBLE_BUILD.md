...
`qml-source/`. It includes the tree-shaken Zui/Omarchy host graph and the generated
...
byte count from `qml-source/`; builds the module in a fresh directory; verifies each
