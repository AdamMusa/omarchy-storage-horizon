...
source_root="$repo_root/qml-source"
report="$repo_root/omarchy-ui-qml-bundle.json"
...
echo "Reproduced the checked-in QML bundle from qml-source with Qt $actual_qt."
